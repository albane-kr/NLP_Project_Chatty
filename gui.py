...
def sendText():
    ...
    if userInput:
        ...
        if emotion_global != "":
            response_gemini, emotion, wav_path, video_path = emotionalFace.emotionalFace(userInput, next(n), emotion_global) 
        else:
            response_gemini, emotion, wav_path, video_path = emotionalFace.emotionalFace(userInput, next(n)) 
...
def recordAndProcess():
    ...
    filename, text, audio_emotion = record_audio(10, "./audio_in/output{n}.wav")
